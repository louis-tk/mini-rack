...
## [Mikrotik L009/RB5009 Router 10" Mount](./STLs/Mikrotik%20-%20L009%20-%2010in.stl)
...
which all appear to share the same form factor. The base version of the mount has a cut-out for the power cable to pass through, there is a version [here](./STLs/Mikrotik%20-%20L009%20-%2010in%20-%20no%20cable%20hole.stl) without the cut-out if the power cable is not needed (eg. if using PoE, or the side power plug on the RB5009 based routers).
...
<img src="./images/mikrotik_L009/03.jpg" width="250">
